...
void recursiveMatTrans (
    ...
    if (n <= 4) { // base case
        ...
        recursiveMatTrans(global_n, n>>1, A, offset_row_A + half, offset_col_A + half, B, offset_row_B + half, offset_col_B + half);
        recursiveMatTrans(global_n, n>>1, A, offset_row_A + half, offset_col_A, B, offset_row_B, offset_col_B + half);
        recursiveMatTrans(global_n, n>>1, A, offset_row_A, offset_col_A + half, B, offset_row_B + half, offset_col_B);
    }
}
